...
public class ArrayEquals {
    ...
    public static void main(String[] args) {
        ...
        if (Arrays.equals(nums3, nums4)) {
            System.out.println("nums3 and nums4 match");
        }else {
            System.out.println("nums3 and nums4 mis-match");
        }
        ...
        if (Arrays.toString(cars2).equalsIgnoreCase(Arrays.toString(cars3))) {
            System.out.println("cars2 == cars3 match - ignorcase");
        }
