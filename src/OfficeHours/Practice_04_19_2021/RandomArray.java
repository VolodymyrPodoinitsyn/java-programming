...
public class RandomArray {
    ...
    public static void main(String[] args) {
        ...
        2) Ask the user the max number they want for the random numbers - Use this as the bound
        3) Create an int array with random numbers. The number of elements is based on the given
        Flow:
